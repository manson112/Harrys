...
static inline void bset_reg_set_bit(int nr, volatile unsigned long *vaddr) {
  ...
  __asm__ __volatile__("bset %1,(%0)" : : "a"(p), "di"(nr & 7) : "memory");
}
...
#define set_bit(nr, vaddr)                                                     \
  (__builtin_constant_p(nr) ? bset_mem_set_bit(nr, vaddr)                      \
...
static inline void bclr_reg_clear_bit(int nr, volatile unsigned long *vaddr) {
  ...
  __asm__ __volatile__("bclr %1,(%0)" : : "a"(p), "di"(nr & 7) : "memory");
}
...
#define clear_bit(nr, vaddr)                                                   \
  (__builtin_constant_p(nr) ? bclr_mem_clear_bit(nr, vaddr)                    \
...
static inline void bchg_reg_change_bit(int nr, volatile unsigned long *vaddr) {
  ...
  __asm__ __volatile__("bchg %1,(%0)" : : "a"(p), "di"(nr & 7) : "memory");
}

static inline void bchg_mem_change_bit(int nr, volatile unsigned long *vaddr) {
  char *p = (char *)vaddr + (nr ^ 31) / 8;

  __asm__ __volatile__("bchg %1,%0" : "+m"(*p) : "di"(nr & 7));
}
...
#define change_bit(nr, vaddr)                                                  \
  (__builtin_constant_p(nr) ? bchg_mem_change_bit(nr, vaddr)                   \
...
#define test_and_set_bit(nr, vaddr)                                            \
  (__builtin_constant_p(nr) ? bset_mem_test_and_set_bit(nr, vaddr)             \
...
#define test_and_clear_bit(nr, vaddr)                                          \
  (__builtin_constant_p(nr) ? bclr_mem_test_and_clear_bit(nr, vaddr)           \
...
#define test_and_change_bit(nr, vaddr)                                         \
  (__builtin_constant_p(nr) ? bchg_mem_test_and_change_bit(nr, vaddr)          \
...
static inline int find_first_zero_bit(const unsigned long *vaddr,
  ...
  __asm__ __volatile__("bfffo %1{#0,#0},%0" : "=d"(res) : "d"(num & -num));
  res ^= 31;
out:
...
static inline unsigned long ffz(unsigned long word) {
  ...
  __asm__ __volatile__("bfffo %1{#0,#0},%0" : "=d"(res) : "d"(~word & -~word));
  return res ^ 31;
}
...
static inline int __ffs(int x) {
  __asm__ __volatile__("bitrev %0; ff1 %0" : "=d"(x) : "0"(x));
  return x;
}
...
static inline int ffs(int x) {
  ...
  __asm__("bfffo %1{#0:#0},%0" : "=d"(cnt) : "dm"(x & -x));
  return 32 - cnt;
}
...
static inline int fls(int x) {
  ...
  __asm__("bfffo %1{#0,#0},%0" : "=d"(cnt) : "dm"(x));
  return 32 - cnt;
}

static inline int __fls(int x) { return fls(x) - 1; }
