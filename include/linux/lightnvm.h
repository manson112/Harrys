...
static inline void *nvm_rq_to_pdu(struct nvm_rq *rqdata) { return rqdata + 1; }
...
extern int nvm_set_tgt_bb_tbl(struct nvm_tgt_dev *, struct ppa_addr *, int,
                              int);
...
static inline int nvm_register(struct nvm_dev *dev) { return -EINVAL; }
